"""
Django settings for proorg project.
...
SECRET_KEY = 'i)%^^zrdojut5r877ktr)(=+4x_nsd2g&3qd(*pn2ld@%kds5%'
...
WSGI_APPLICATION = 'proorg.wsgi.application'
...
STATICFILES_DIRS = [
    ...
    ("media", "E:/python/home_work/client-list/proorg/media"),
]
